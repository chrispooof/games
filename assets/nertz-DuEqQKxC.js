...
`)+`
`+p);const M=y+m+a,b=y+p+o,w=jl(i,i.VERTEX_SHADER,M),A=jl(i,i.FRAGMENT_SHADER,b);i.attachShader(v,w),i.attachShader(v,A),t.index0AttributeName!==void 0?i.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(v,0,"position"),i.linkProgram(v);function C(R){if(s.debug.checkShaderErrors){const H=i.getProgramInfoLog(v)||"",U=i.getShaderInfoLog(w)||"",k=i.getShaderInfoLog(A)||"",B=H.trim(),F=U.trim(),O=k.trim();let $=!0,K=!0;if(i.getProgramParameter(v,i.LINK_STATUS)===!1)if($=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,v,w,A);else{const he=Yl(i,w,"vertex"),pe=Yl(i,A,"fragment");Ce("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(v,i.VALIDATE_STATUS)+`
