 ...
 * @param total - Total number of players (determines angle spacing)
 * @param seatRadius - Distance from table center to each seat (world units)
 */
 ...
 * Piles are arranged in a symmetric row perpendicular to the radial direction:
 *   [Nertz, Work1, Work2, Work3, Work4, Waste, Stock]
 *   (indices 0–6; centered at index 3)
 * @param seat - The player's seat transform
 * @param seatRadius - Distance from table center to each seat (world units)
 * @param pileOffset - How far in front of the seat the pile row is positioned
 */
